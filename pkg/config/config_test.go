...
func TestDefaultConfig_WorkspacePath_Default(t *testing.T) {
	...
	cfg := DefaultConfig()
	want := filepath.Join("/tmp/home", ".qclaw", "workspace")
...
func TestDefaultConfig_WorkspacePath_WithQClawHome(t *testing.T) {
	t.Setenv("QCLAW_HOME", "/custom/qclaw/home")

	cfg := DefaultConfig()
	want := "/custom/qclaw/home/workspace"

	if cfg.Agents.Defaults.Workspace != want {
		t.Errorf("Workspace path with QCLAW_HOME = %q, want %q", cfg.Agents.Defaults.Workspace, want)
	}
}
