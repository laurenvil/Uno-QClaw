...
import (
	...
	anthropicprovider "github.com/laurenvil/Uno-QClaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: qclaw auth login --provider anthropic")
		}
