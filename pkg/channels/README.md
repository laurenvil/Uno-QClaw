...
> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/qclaw/internal/gateway/`
...
import (
    "github.com/laurenvil/Uno-QClaw/pkg/bus"
    "github.com/laurenvil/Uno-QClaw/pkg/channels"     // Reference parent package
    "github.com/laurenvil/Uno-QClaw/pkg/config"
    "github.com/laurenvil/Uno-QClaw/pkg/identity"      // New
    "github.com/laurenvil/Uno-QClaw/pkg/media"          // New (if media support needed)
)
```
...
import (
    _ "github.com/laurenvil/Uno-QClaw/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/laurenvil/Uno-QClaw/pkg/channels/discord"
    _ "github.com/laurenvil/Uno-QClaw/pkg/channels/your_new_channel"  // New addition
)
```
