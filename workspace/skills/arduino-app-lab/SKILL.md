...
- **Editing `~/.picoclaw/workspace/` and expecting App Lab to see it.** Those are QClaw's workspace files (SOUL.md, skills, sessions), not App Lab Apps. App Lab Apps live wherever you save them in App Lab.
