...
Examples:
  qclaw model                    # Show current default model
  qclaw model gpt-5.2           # Set gpt-5.2 as default
  qclaw model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  qclaw model local-model       # Set local VLLM server as default
