...
import (
	...
	"github.com/laurenvil/Uno-QClaw/pkg/migrate"
)
...
func NewMigrateCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "migrate",
		Short: "Migrate from xxxclaw(openclaw, etc.) to QClaw",
		Args:  cobra.NoArgs,
		Example: `  qclaw migrate
  qclaw migrate --from openclaw
  qclaw migrate --dry-run
  qclaw migrate --refresh
  qclaw migrate --force`,
	...
	cmd.Flags().StringVar(&opts.TargetHome, "target-home", "",
		"Override target home directory (default: ~/.qclaw)")
