...
private:
    ...
    bool load_model(const common_params & params) {
        ...
        // Skip speculative compatibility check — it runs a GPU decode that triggers
        // GGML_ASSERT(0) on OpenCL backends that return CL_OUT_OF_RESOURCES on readback.
        // We are not using speculative decoding so this check is unnecessary.
        const bool can_spec = false;
