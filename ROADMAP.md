...
* [**Memory Footprint Reduction**](https://github.com/laurenvil/Uno-QClaw/issues/346) 
...
* **Channel**
  ...
  * [**attachment**](https://github.com/laurenvil/Uno-QClaw/issues/348): Native handling of images, audio, and video attachments.


* **Skill Marketplace**
  * [**Discovery skills**](https://github.com/laurenvil/Uno-QClaw/issues/287): Implement `find_skill` to automatically discover and install skills from the [GitHub Skills Repo] or other registries.
...
* **Operations**
  * [**MCP Support**](https://github.com/laurenvil/Uno-QClaw/issues/290): Native support for the **Model Context Protocol (MCP)**.
  * [**Browser Automation**](https://github.com/laurenvil/Uno-QClaw/issues/293): Headless browser control via CDP (Chrome DevTools Protocol) or ActionBook.
  * [**Mobile Operation**](https://github.com/laurenvil/Uno-QClaw/issues/292): Android device control (similar to BotDrop).


* **Multi-Agent Collaboration**
  * [**Basic Multi-Agent**](https://github.com/laurenvil/Uno-QClaw/issues/294) implement
  * [**Model Routing**](https://github.com/laurenvil/Uno-QClaw/issues/295): "Smart Routing" — dispatch simple tasks to small/local models (fast/cheap) and complex tasks to SOTA models (smart).
  * [**Swarm Mode**](https://github.com/laurenvil/Uno-QClaw/issues/284): Collaboration between multiple PicoClaw instances on the same network.
  * [**AIEOS**](https://github.com/laurenvil/Uno-QClaw/issues/296): Exploring AI-Native Operating System interaction paradigms.
...
* [**QuickGuide (Zero-Config Start)**](https://github.com/laurenvil/Uno-QClaw/issues/350)
...
* [**Logo Design**](https://github.com/laurenvil/Uno-QClaw/issues/297): We are looking for a **Mantis Shrimp (Stomatopoda)** logo design!
